 ...
 * @param {string} PUSHWOOSH_SERVICE_WORKER_URL - '/service-worker.js'
 * @param {string} PUSHWOOSH_SAFARI_WEB_SITE_PUSH_ID - 'web.com.pushwoosh.websiteid'
 * @param {string} APPLICATION_CODE - 'XXXXX-XXXXX'
 */
module.exports = function(serviceWorkerURL, safariPushID, appCode){


	var PUSHWOOSH_SERVICE_WORKER_URL = serviceWorkerURL;
	var PUSHWOOSH_SAFARI_WEB_SITE_PUSH_ID = safariPushID;	//Enter your Safari website ID here

	var PushwooshBase = function()
	{
		this.APPLICATION_CODE = appCode; // Your Application Code from Pushwoosh
